    ...
    private void applyClickEvents(final MyViewHolder holder, final int position) {
        ...
        holder.messageContainer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(messages.get(position).getEstado().equalsIgnoreCase("Abierto") && ( varPublicas.idCanal.equalsIgnoreCase("2841") || varPublicas.idCanal.equalsIgnoreCase("4571"))) // Sólo se podrán comentar los tickets abiertos y si el usuario es de canal POSTVENTA y WHATSAPP
                {
